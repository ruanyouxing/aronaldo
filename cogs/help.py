...
class help(commands.Cog):
    ...
    async def help(self, ctx, command_name: str = None):
            ...
            """, inline = False)
            thongbao.set_image(url="attachment://thongbao_sample.png")
            ...
            **Lưu ý:** Nếu tham số được truyền vào bằng dấu chấm (.), nội dung đó sẽ bị xoá 
            ...
            phu_luc.add_field(name = "1. Đối với người dùng", value = f"""
                ...
                **Lưu ý:** Khi thông báo được gửi lên kênh công khai, **người dùng đó sẽ bị ping**
            """, inline = False)
            ...
            phu_luc.add_field(name = "3. Đối với role", value = f"""
                ...
                Ví dụ: `<@&123456789012345678>`
                **Lưu ý**: Tương tự với ID người dùng, **tất cả những người có role đó cũng sẽ bị ping**
            """, inline = False)
